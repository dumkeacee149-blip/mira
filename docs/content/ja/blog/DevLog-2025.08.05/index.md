...
function handleOpenLatest() {
  window.open('https://github.com/dumkeacee149-blip/mira/releases/latest', '_blank')
}
</script>
...
- [**391 コミット**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**1017 ファイル変更**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**74,548 行のコード追加**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**13,930 行のコード削除**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
...
- [Product Hunt](https://www.producthunt.com/products/mira) で自己紹介を公開しました
...
Tamagotchi は MIRA デスクトップ版の名前です。
...
<ThemedVideo autoplay src="/en/blog/DevLog-2025.08.05/assets/mira-demo-fade-on-hover.mp4" />
...
VTuber ストリーミングに MIRA を使用する場合、ホバーフェード機能を使用しなくても問題ありませんが、
...
<ThemedVideo autoplay src="/en/blog/DevLog-2025.08.05/assets/mira-demo-move.mp4" />
...
<ThemedVideo autoplay src="/en/blog/DevLog-2025.08.05/assets/mira-demo-resize.mp4" />
...
<ThemedVideo autoplay src="/en/blog/DevLog-2025.08.05/assets/mira-demo-resource-island.mp4" />
...
[candle-examples](https://github.com/proj-mira/candle-examples) で行った実験のおかげで、
Windows、macOS、Linux で動作するローカル ASR/STT エンジンができました。

<ThemedVideo autoplay src="/en/blog/DevLog-2025.08.05/assets/mira-demo-settings-hearing.mp4" />
...
現在、MIRA の設定はかなり複雑であることを私たちは知っています（それでも、他の多くの純粋な Python ベースのものと比較すれば簡単ですが、
それらは構成するためにコード構造を理解する必要があります）。

[Me1td0wn76 (melty kiss)](https://github.com/Me1td0wn76) の貢献のおかげで、
Web 版にオンボーディングサポートが追加されました。これで、初めて MIRA を使用するときに
より良い体験を得ることができます。

彼らは Pull Request がマージされた後、Project Mira に貢献した経験を共有するためにブログ記事を書きました：[MIRAプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/mira/)

<img class="light" src="/en/blog/DevLog-2025.08.05/assets/mira-demo-onboarding-light.avif" alt="オンボーディング ライトモード" />
<img class="dark" src="/en/blog/DevLog-2025.08.05/assets/mira-demo-onboarding-dark.avif" alt="オンボーディング ダークモード" />

実際の動作をご覧ください：

<ThemedVideo
  autoplay
  light="/en/blog/DevLog-2025.08.05/assets/mira-demo-onboarding-light.mp4"
  dark="/en/blog/DevLog-2025.08.05/assets/mira-demo-onboarding-dark.mp4"
/>
...
<img class="light" src="/en/blog/DevLog-2025.08.05/assets/mira-demo-vrm-light.avif" alt="時系列チャート ライトモード" />
<img class="dark" src="/en/blog/DevLog-2025.08.05/assets/mira-demo-vrm-dark.avif" alt="時系列チャート ダークモード" />
...
<ThemedVideo
  autoplay
  light="/en/blog/DevLog-2025.08.05/assets/mira-demo-onboarding-mobile-light.mp4"
  dark="/en/blog/DevLog-2025.08.05/assets/mira-demo-onboarding-mobile-dark.mp4"
/>
...
<ThemedVideo
  autoplay
  light="/en/blog/DevLog-2025.08.05/assets/mira-demo-quick-editor-mobile-light.mp4"
  dark="/en/blog/DevLog-2025.08.05/assets/mira-demo-quick-editor-mobile-dark.mp4"
/>
...
<video class="light" autoplay controls muted loop>
  <source src="/en/blog/DevLog-2025.08.05/assets/mira-demo-clustr-light.mp4" type="video/mp4">
  お使いのブラウザは動画タグをサポートしていません。
</video>

<video class="dark" autoplay controls muted loop>
  <source src="/en/blog/DevLog-2025.08.05/assets/mira-demo-clustr-dark.mp4" type="video/mp4">
  お使いのブラウザは動画タグをサポートしていません。
</video>

#### レベルメーター

> UI コンポーネント：https://mira.local/ui/#/story/src-components-gadgets-levelmeter-story-vue

検出された音声入力レベルやリアルタイムのシステム負荷を表示する場合に便利です：

<img class="light" src="/en/blog/DevLog-2025.08.05/assets/mira-ui-level-meter-light.avif" alt="レベルメーター ライトモード" />
<img class="dark" src="/en/blog/DevLog-2025.08.05/assets/mira-ui-level-meter-dark.avif" alt="レベルメーター ダークモード" />

#### 時系列チャート

> UI コンポーネント：https://mira.local/ui/#/story/src-components-gadgets-timeserieschart-story-vue

変化する値のレベルメーターに似ていますが、特に履歴データに役立ちます。

<img class="light" src="/en/blog/DevLog-2025.08.05/assets/mira-ui-time-series-chart-light.avif" alt="時系列チャート ライトモード" />
<img class="dark" src="/en/blog/DevLog-2025.08.05/assets/mira-ui-time-series-chart-dark.avif" alt="時系列チャート ダークモード" />

さらに多くのコンポーネントを追加しました...

- [x] `<Progress />`（@Menci に感謝 [2cb602aa](https://github.com/dumkeacee149-blip/mira/commit/2cb602aa3eac456a479b622a5ecf043831597ffe)）
- [x] `<FieldSelect />` ([d0d782ff](https://github.com/dumkeacee149-blip/mira/commit/d0d782ff94a5a0a12819725303f687bd1a47e87c))
- [x] `<Alert />`（[@typed-sigterm](https://github.com/typed-sigterm) に感謝, [#295](https://github.com/dumkeacee149-blip/mira/pull/295)）
- [x] `<ErrorContainer />`（[@typed-sigterm](https://github.com/typed-sigterm) に感謝, [#295](https://github.com/dumkeacee149-blip/mira/pull/295)）
...
<video class="light" autoplay controls muted loop>
  <source src="/en/blog/DevLog-2025.08.05/assets/mira-docs-light.mp4" type="video/mp4">
  お使いのブラウザは動画タグをサポートしていません。
</video>

<video class="dark" autoplay controls muted loop>
  <source src="/en/blog/DevLog-2025.08.05/assets/mira-docs-dark.mp4" type="video/mp4">
  お使いのブラウザは動画タグをサポートしていません。
</video>
...
<img class="light" src="/en/blog/DevLog-2025.08.05/assets/mira-docs-blogs-light.avif" alt="ブログ ライトモード" />
<img class="dark" src="/en/blog/DevLog-2025.08.05/assets/mira-docs-blogs-dark.avif" alt="ブログ ダークモード" />
...
まず https://github.com/dumkeacee149-blip/mira/tree/main/packages/i18n/src/locales に移動してください。

<img class="light" src="/en/blog/DevLog-2025.08.05/assets/mira-packages-i18n-light.avif" alt="i18n パッケージ ライトモード" />
<img class="dark" src="/en/blog/DevLog-2025.08.05/assets/mira-packages-i18n-dark.avif" alt="i18n パッケージ ダークモード" />
...
`turborepo` を使用すると、MIRA のビルドに必要な時間が**平均4分から25秒に短縮**されました。

### Nix をサポート

[@Weathercold (Weathercold)](https://github.com/Weathercold) のおかげで、
MIRA をビルドするための Nix flake ができました。これはクロスプラットフォーム互換性への素晴らしい追加です。
macOS でも動作します。
...
```bash
nix run --extra-experimental-features 'nix-command flakes' github:dumkeacee149-blip/mira
```
...
ナイトリービルドは https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml で見つけることができます
...
- [`@proj-mira/chromatic`](https://github.com/proj-mira/chromatic)（[@sumimakito](https://github.com/sumimakito) 作）
- [`@proj-mira/unocss-preset-chromatic`](https://github.com/proj-mira/chromatic)（[@sumimakito](https://github.com/sumimakito) 作）
...
- [`@proj-mira/drizzle-orm-browser`](https://github.com/proj-mira/drizzle-orm-browser)（私作）

このバージョンの間に誕生したサイドプロジェクト：

- [HuggingFace Inspector](https://hf-inspector.moeru.ai/) (https://github.com/moeru-ai/hf-inspector)
- [whisper & VAD、candle、burn、ort に関するその他の candle の例](https://github.com/proj-mira/candle-examples)
...
ロードマップ上の [Roadmap v0.7](https://github.com/dumkeacee149-blip/mira/issues/200) を追跡および確認できます。
