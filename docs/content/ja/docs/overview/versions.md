---
title: バージョン一覧
description: MIRA の異なるバージョンと入手方法
---
...
MIRA は、さまざまなニーズに合わせて複数のリリースチャンネルを提供しています。最も安定した体験を求めている場合でも、最新の機能を求めている場合でも、あなたにぴったりのものが見つかります。
...
[GitHub で以前のすべてのリリースを見る →](https://github.com/dumkeacee149-blip/mira/releases)
...
1. [Nightly Build Workflow](https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml) ページにアクセスします
...
4. プラットフォーム用のビルドをダウンロードします：
   ...
   - **Linux (x64)**: `mira_*_amd64.deb` または `mira-*.x86_64.rpm`
   - **Linux (ARM64)**: `mira_*_arm64.deb` または `mira-*.aarch64.rpm`
...
[すべてのナイトリービルドを見る →](https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml)
