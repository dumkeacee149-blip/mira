...
fundamental animations and transitions for MIRA.
...
> "proj-mira" + "${subDirectory}" + "$｛packageName}" pattern for the Netlify
> deployment.
...
I deployed the official documentation site onto [https://mira.build](https://mira.build) yesterday,
[@kwaa](https://github.com/kwaa) commented that he would suggest me try
the `https://mira.more.ai/docs` approach instead, ~~but I couldn't figure out~~
...
capable of porting for MIRA to use, good news is,
...
animation component into MIRA's website main stage, it wasn't that smooth,
...
already at our official deployment at [https://mira.local](https://mira.local).
