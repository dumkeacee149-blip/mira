...
- [**391 commits**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**1017 files changed**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**74,548 lines added**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**13,930 lines removed**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
...
- We announced ourselves on [Product Hunt](https://www.producthunt.com/products/mira)
...
Tamagotchi is the name of the Desktop version of MIRA, where you can have it
...
<ThemedVideo autoplay src="./assets/mira-demo-fade-on-hover.mp4" />
...
If you are going to use MIRA for VTuber streaming, it's fine to not having
...
inside MIRA to fade out when the mouse is hovering over the window, and
...
MIRA to stay with me with any applications I use now without worrying about
to disable or organize the order of the windows. Everyday when I developing
MIRA, no matter it's Web version or Desktop version, I will always open her
...
<ThemedVideo autoplay src="./assets/mira-demo-move.mp4" />
...
<ThemedVideo autoplay src="./assets/mira-demo-resize.mp4" />
...
<video autoplay controls muted loop>
  <source src="./assets/mira-demo-resource-island.mp4" type="video/mp4">
...
we have done in the repository [candle-examples](https://github.com/proj-mira/candle-examples),
we now have a local ASR/STT engine that works on Windows, macOS and Linux.

<video autoplay controls muted loop>
  <source src="./assets/mira-demo-settings-hearing.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
We know that configuring MIRA is quite complex now (but still easy if comparing
...
have a much better experience when you first time using MIRA.

They wrote a blog after the Pull Request being merged to share the
experience contributing Project Mira: [MIRAプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/mira/)

<img class="light" src="./assets/mira-demo-onboarding-light.avif" alt="Onboarding light mode" />
<img class="dark" src="./assets/mira-demo-onboarding-dark.avif" alt="Onboarding dark mode" />

See it in action:

<ThemedVideo
  autoplay
  light="./assets/mira-demo-onboarding-light.mp4"
  dark="./assets/mira-demo-onboarding-dark.mp4"
/>
...
<img class="light" src="./assets/mira-demo-vrm-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/mira-demo-vrm-dark.avif" alt="Time series chart dark mode" />
...
<ThemedVideo
  autoplay
  light="./assets/mira-demo-onboarding-mobile-light.mp4"
  dark="./assets/mira-demo-onboarding-mobile-dark.mp4"
/>
...
<video class="light" autoplay controls muted loop>
  <source src="./assets/mira-demo-quick-editor-mobile-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/mira-demo-quick-editor-mobile-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
<video class="light" autoplay controls muted loop>
  <source src="./assets/mira-demo-clustr-light.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

<video class="dark" autoplay controls muted loop>
  <source src="./assets/mira-demo-clustr-dark.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>

#### Level meter

> UI Component: https://mira.local/ui/#/story/src-components-gadgets-levelmeter-story-vue

Useful when wishing to display the detected meter of the audio input, or
the realtime system load:

<img class="light" src="./assets/mira-ui-level-meter-light.avif" alt="Level meter light mode" />
<img class="dark" src="./assets/mira-ui-level-meter-dark.avif" alt="Level meter dark mode" />

#### Time series chart

> UI Component: https://mira.local/ui/#/story/src-components-gadgets-timeserieschart-story-vue

Similar to the Level meter for changing values, but especially useful for
historical data.

<img class="light" src="./assets/mira-ui-time-series-chart-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/mira-ui-time-series-chart-dark.avif" alt="Time series chart dark mode" />

There are many more components we added...

- [x] `<Progress />` (thanks to @Menci [2cb602aa](https://github.com/dumkeacee149-blip/mira/commit/2cb602aa3eac456a479b622a5ecf043831597ffe))
- [x] `<FieldSelect />` ([d0d782ff](https://github.com/dumkeacee149-blip/mira/commit/d0d782ff94a5a0a12819725303f687bd1a47e87c))
- [x] `<Alert />` (thanks [@typed-sigterm](https://github.com/typed-sigterm), [#295](https://github.com/dumkeacee149-blip/mira/pull/295))
- [x] `<ErrorContainer />`  (thanks [@typed-sigterm](https://github.com/typed-sigterm), [#295](https://github.com/dumkeacee149-blip/mira/pull/295))
...
<ThemedVideo
  autoplay
  light="./assets/mira-docs-light.mp4"
  dark="./assets/mira-docs-dark.mp4"
/>
...
<img class="light" src="./assets/mira-docs-blogs-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/mira-docs-blogs-dark.avif" alt="Time series chart dark mode" />
...
or fixing existing ones, please navigate to https://github.com/dumkeacee149-blip/mira/tree/main/packages/i18n/src/locales
first.

<img class="light" src="./assets/mira-packages-i18n-light.avif" alt="Time series chart light mode" />
<img class="dark" src="./assets/mira-packages-i18n-dark.avif" alt="Time series chart dark mode" />
...
With `turborepo`, the time it requires to build MIRA **reduced from 4 minutes
to 25 seconds in average**.

### Now Nix is supported

Thanks to [@Weathercold (Weathercold)](https://github.com/Weathercold), we now
have a Nix flake to build MIRA, which is a great addition to the
...
Nightly builds can be found at https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml
...
- [`@proj-mira/chromatic`](https://github.com/proj-mira/chromatic) (by [@sumimakito](https://github.com/sumimakito))
- [`@proj-mira/unocss-preset-chromatic`](https://github.com/proj-mira/chromatic) (by [@sumimakito](https://github.com/sumimakito))
...
- [`@proj-mira/drizzle-orm-browser`](https://github.com/proj-mira/drizzle-orm-browser) (by me)
...
- [More candle examples about whisper & VAD, candle, burn, and ort](https://github.com/proj-mira/candle-examples)
...
at [Roadmap v0.7](https://github.com/dumkeacee149-blip/mira/issues/200) on our roadmap.
