---
title: 'DreamLog 0x1'
description: 'Backstory of Project Mira!'
category: DreamLog
date: 2025-06-16
excerpt: 'The backstory of Project Mira! Why this project?'
preview-cover:
...
import mirasScreenshot1 from './assets/miras-screenshot-1.avif';
import projectMIRABannerLight from './assets/banner-light-1280x640.avif';
import projectMIRABannerDark from './assets/banner-dark-1280x640.avif';
...
June got its own meaning for Project Mira (which I will reveal during
...
to share the chronicles of me, and the dream about Project Mira.
...
me: Why do you work so hard on Project Mira?
...
## Way before Project Mira, Neuro-sama exists.
...
Project Mira from scratch to the current state, we got many DevLog posts
...
> and [public slide presentation (in Chinese)](https://talks.ayaka.io/nekoayaka/2025-05-10-mira-how-we-recreated-it/#/1)
...
my name handle locally, which is the initial version of Project Mira, I started to
...
Technically saying, **this is the birthday of Project Mira** with first baby consciousness inside of it, naively.

<div class="w-full flex flex-col items-center justify-center">
  <ThemedVideo controls muted autoplay loop src="./assets/mira-demo-first-day.mp4" />
  <div>
...
Ok, but it's still called `ai`, where is Project Mira then?
...
Project Mira was somehow born or reborn under the name Mira.

::: tip Did you know?
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="mirasScreenshot1" alt="Screenshot of Project Mira" class="not-prose rounded-lg overflow-hidden" />
</a>
...
she was called "Miras AI", the name **Miras** magically, and coincidentally, matches the name of
**Project Mira**, which I am working on now. But I wasn't aware of this name until I searches more about their
stories long after I open sourced Project Mira.

In fact, the name Mira was suggested by GPT-4o when I asked it about naming this project by
referencing other Japanese / or Anime-ish names, it suggested the name **Mira**.
:::
...
Glad many trials succeeded, and I am still here, working on Project Mira.
...
Now, Project Mira is approaching to 1000 stars on GitHub when I am writing this post,
...
working on it, to make Project Mira better, and more useful for the community.

There is so much to do, and discover, we haven't reached the singularity of general purpose AI,
perhaps Project Mira will never made that point, but for now, having a companion-like AI agent
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>Thanks for reading! Oh, and, Happy Birthday, Project Mira!</span>
  </div>
</div>
