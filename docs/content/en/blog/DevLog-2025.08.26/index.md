...
date: 2025-08-26
excerpt: |
  Sharing some progress on the pure vision direction of `mira-factorio`, solidifying thoughts to prevent them from evaporating.
preview-cover:
# TODO
---
...
Long time no see, everyone! I'm [@LemonNeko](https://github.com/LemonNekoGH), one of the maintainers of MIRA. ~~Ah, getting tired of starting like this, just like an LLM.~~

In my previous [DevLog](../DevLog-2025.07.18/index.md), I mentioned briefly looking at the [Factorio Learning Environment](https://arxiv.org/abs/2503.09617) paper and briefly discussed how we plan to improve `mira-factorio`, but... what I want to share with you today is not about that, but about progress in the pure vision direction.
...
<ThemedVideo src="./assets/mira-factorio-yolo-v0-playground-vnc.mp4" controls playsinline />

In the video, I'm playing Factorio via VNC connection in the web page, with object detection results on the right side, almost in real-time. I've also deployed it to [HuggingFace Space](https://huggingface.co/spaces/proj-mira/factorio-yolo-v0-playground), feel free to try it out.
...
Great! Now the Docker image is ready. You can see the complete [Dockerfile](https://github.com/dumkeacee149-blip/mira-factorio/blob/a6bf243f14cbc0d765ff7ed13389bca33c1fdfa2/docker/Dockerfile) and [usage instructions](https://github.com/dumkeacee149-blip/mira-factorio/tree/ba46a4e47b31187dd064b06314b595b551ed3411/apps/factorio-yolo-v0-playground) here.
...
My collection script is [here](https://github.com/dumkeacee149-blip/mira-factorio/blob/ba46a4e47b31187dd064b06314b595b551ed3411/packages/factorio-rcon-snippets-for-node/src/factorio_yolo_dataset_collector_v0.ts). It uses `typescript-to-lua` to compile TypeScript to Lua, then uses RCON to pass it to Factorio for execution.
...
Oh, and to better debug my collection script, I developed a [VSCode plugin](https://github.com/dumkeacee149-blip/mira-factorio/blob/ba46a4e47b31187dd064b06314b595b551ed3411/packages/vscode-factorio-rcon-evaluator/README.md) that provides a CodeLens operation to compile and execute my script with one click.
...
You can see the dataset, training code, and exported ONNX model [here](https://github.com/dumkeacee149-blip/mira-factorio/blob/ba46a4e47b31187dd064b06314b595b551ed3411/apps/factorio-yolo-v0-playground).
...
You can see the entire Playground's source code [here](https://github.com/dumkeacee149-blip/mira-factorio/tree/ba46a4e47b31187dd064b06314b595b551ed3411/apps/factorio-yolo-v0-playground).
