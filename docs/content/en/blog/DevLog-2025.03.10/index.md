...
feeling of the MIRA stage UI and settings UI, the idea finally appears
...
even in the workflow of Project Mira.
...
[mira](https://github.com/dumkeacee149-blip/mira).

> Where do we go?

Nice question! We got [`@proj-mira`](https://github.com/proj-mira) already
...
packages to [`@proj-mira`](https://github.com/proj-mira).

So, we moved some of the packages and applications into
[`@proj-mira`](https://github.com/proj-mira) organization! You can check them out:

- https://github.com/proj-mira/webai-examples : meant to make demos with WebGPU and
  related stuff.
- https://github.com/proj-mira/lobe-icons : port of
