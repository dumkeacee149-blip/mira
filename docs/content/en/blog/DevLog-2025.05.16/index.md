...
the [Project Mira](https://github.com/dumkeacee149-blip/mira)!

Sorry for being late for new update in
Project Mira through the posted DevLog, please forgive us
for the delay.

> We wrote many fantastic DevLogs about our development
> progress once a while for the past months for MIRA, where
...
For the past few weeks, the major quests of Project Mira itself
...
> Find and click the "Mira Card" button.

<img class="light" :src="CharacterCardMenuLight" alt="screenshot of a menu offers Mira Card menu button" />
<img class="dark" :src="CharacterCardMenuDark" alt="screenshot of a menu offers Mira Card menu button" />

> This will bring you to the "Mira Card editor screen", where you can upload and
> edit your character card for persona customization.

<img class="light" :src="CharacterCardSettingsLight" alt="screenshot of a menu offers Mira Card menu button" />
<img class="dark" :src="CharacterCardSettingsDark" alt="screenshot of a menu offers Mira Card menu button" />
...
It's live in our UI component library, you can play around with it: https://mira.local/ui/#/story/src-components-menu-charactercard-story-vue .
...
- Tauri MCP support
- Connects MIRA to Android devices
...
and [TTS (text to speech)](https://huggingface.co/tasks/text-to-speech) in MIRA
...
to chain many asynchronous tasks together to be able to process data to power MIRA.

That was the time I started to experiment more examples, demos on simplifying VAD,
ASR, TTS workflow.

Eventually, I got this:
[WebAI Realtime Voice Chat Examples](https://github.com/proj-mira/webai-example-realtime-voice-chat),
...
- [VAD + ASR + LLM Chat](https://github.com/proj-mira/webai-example-realtime-voice-chat/tree/8462ff6bcb83bb278bce5388d588d2e3e3dd6dae/apps/vad-asr-chat)
- [VAD + ASR + LLM Chat + TTS](https://github.com/proj-mira/webai-example-realtime-voice-chat/tree/8462ff6bcb83bb278bce5388d588d2e3e3dd6dae/apps/vad-asr-chat-tts)
...
[Sherpa ONNX powered VAD + ASR + LLM Chat + TTS](https://github.com/proj-mira/webai-example-realtime-voice-chat/tree/main/apps/sherpa-onnx-demo)

#### Birth of xsAI 🤗 Transformers.js

Because the work we have done for VAD, ASR, Chat, and TTS demos, this gave the
birth of a new side project called [xsAI 🤗 Transformers.js](https://github.com/proj-mira/xsai-transformers)
...
[https://mira.local/devtools/background-remove](https://mira.local/devtools/background-remove).
...
- New [Tutorial stepper](https://mira.local/ui/#/story/src-components-misc-steppers-steppers-story-vue?variantId=src-components-misc-steppers-steppers-story-vue-0), [File upload](https://mira.local/ui/#/story/src-components-form-input-inputfile-story-vue?variantId=default), and [Textarea](https://mira.local/ui/#/story/src-components-form-textarea-textarea-story-vue?variantId=default) component
- Color issues
- [Typography improved](https://mira.local/ui/#/story/stories-typographysans-story-vue?)

More of the stories can be found at [Roadmap v0.5](https://github.com/dumkeacee149-blip/mira/issues/113)
...
This is me, I shared the MIRA project with other attendees, and we had a great time
...
it here too: [https://talks.ayaka.io/nekoayaka/2025-05-10-mira-how-we-recreated-it/#/1](https://talks.ayaka.io/nekoayaka/2025-05-10-mira-how-we-recreated-it/#/1)
...
- 92 tasks finished for [Roadmap v0.5](https://github.com/dumkeacee149-blip/mira/issues/113)
  - UI
