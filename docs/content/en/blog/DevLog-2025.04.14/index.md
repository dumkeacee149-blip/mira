...
[Last time](../DevLog-2025.04.06/#memory-system-memory-system) we discussed MIRA's memory system. Today, let's dive deeper into how to implement such a complex memory system and explore future prospects.
...
To build a good memory layer for MIRA, we need to establish a good reranking mechanism, combining RAG basic capabilities with past search engine reranking experience.

## Memory Layer Experimental Platform

[Project Mira Memory Driver @duckdb/duckdb-wasm Playground](https://drizzle-orm-duckdb-wasm.netlify.app/#/memory-decay)
...
## How Should MIRA Be Designed?

From this, we can glimpse MIRA's implementation principles:
