...
basic/first version of Project Mira logo. The feeling of the logo looks like
this:

![](./assets/mira-logos-v1.avif)
...
[documentation site](https://mira.build) along with the color palette:

![](./assets/mira-build-light.avif)
![](./assets/mira-build-dark.avif)
...
[https://mira.build](https://mira.build) site, you can check them out.
