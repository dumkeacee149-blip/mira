...
MIRA on Discord, bilibili, and many other social media platforms.
...
> Ahh, don't worry, our beloved [MIRA](https://github.com/dumkeacee149-blip/mira) will
...
and have the same scheme of feelings of Project Mira's theme, was it?
...
of MIRA, that's why I designed another dedicated logo for the UI page:
...
- [x] Component for (almost all the todo components on the [Roadmap](https://github.com/dumkeacee149-blip/mira/issues/42))
  - [x] Form
    - [x] Radio
    - [x] Radio Group
    - [x] Model Catalog
