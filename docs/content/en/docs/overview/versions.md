---
title: Versions
description: Different versions of MIRA and how to get them
---
...
MIRA offers multiple release channels to suit different needs. Whether you want the most stable experience or the latest features, we've got you covered.
...
[View all releases on GitHub →](https://github.com/dumkeacee149-blip/mira/releases)
...
1. Visit the [Nightly Build Workflow](https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml) page
2. Click on the most recent successful run (indicated by a green checkmark ✓)
3. Scroll down to the **Artifacts** section
4. Download the build for your platform:
   - **Windows**: `MIRA_*_x64_en-US.exe`
   - **macOS (Intel)**: `MIRA_*_x64.dmg`
   - **macOS (Apple Silicon)**: `MIRA_*_arm64.dmg`
   - **Linux (x64)**: `mira_*_amd64.deb` or `mira-*.x86_64.rpm`
   - **Linux (ARM64)**: `mira_*_arm64.deb` or `mira-*.aarch64.rpm`
...
[View all nightly builds →](https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml)
