...
上周，我们的企业设计师/艺术家提交了 Project Mira 标志的第一版设计稿。
标志的整体风格看起来是这样的：
...
今天晚些时候，我将 Project Mira 的[文档网站](https://mira.build)正式上线，
为我自己以及其他开发者和艺术家提供参考和指南。

终于完成了！新设计的标志和配色方案都已经整合到[文档网站](https://mira.build)中：
...
我已经将这些相关资源和网站链接都添加到了 [https://mira.build](https://mira.build) 网站，欢迎大家前去查看。

## 开发直播

我将 [yui540](https://github.com/yui540) [仓库](https://github.com/yui540/css-animations) 中的
许多动画过渡效果移植到了 [https://proj-mira-packages-ui-transitions.netlify.app/#/](https://proj-mira-packages-ui-transitions.netlify.app/#/)。
