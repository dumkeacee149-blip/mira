...
date: 2026-01-01
excerpt: |
  和大家分享 MIRA 在 iOS 平台上的进展，遇到的问题与解决方案，以及柠猫在 FlowChat 实验记忆层的一些成果和一点点实现细节。
preview-cover:
  light: "@assets('./assets/cover-light.png')"
  dark: "@assets('./assets/cover-dark.png')"
---

新年快乐！这里是 [@LemonNekoGH](https://github.com/LemonNekoGH)，MIRA 的维护者之一，新年的第一篇 DevLog 是我的了，（按下 B 键选择了大笑表情）啊哈哈哈哈哈哈！
...
在两天前，我们引入了 [Capacitor](https://capacitorjs.com/) 来为 MIRA 构建移动端应用（[#845](https://github.com/dumkeacee149-blip/mira/pull/845)），我们称之为 MIRA Pocket。
...
在视频中，我把 MIRA 从后台列表移除了，不久后 MIRA 就弹出了一条通知，这种后台通知在 PWA 中很难做到，在 iOS 原生应用上就轻而易举了。
