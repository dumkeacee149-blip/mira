...
- [**391 次提交**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**1017 个文件变更**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**74,548 行代码新增**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
- [**13,930 行代码删除**](https://github.com/dumkeacee149-blip/mira/compare/v0.6.1...v0.7.0)
...
- 我们在 [Product Hunt](https://www.producthunt.com/products/mira) 上发布了自我介绍
...
Tamagotchi 是 MIRA 桌面版本的名称，你可以让它作为独立的、
...
如果你打算使用 MIRA 进行 VTuber 流媒体，不使用悬停淡出功能是可以的，
...
这就是为什么我们想出了这个主意：创建一个功能，允许 MIRA 中的任何角色
在鼠标悬停在窗口上时淡出，并将鼠标点击事件传递给其下方的应用程序。

我个人非常喜欢这个功能，因为我现在可以让 MIRA 中的角色
与我一起使用任何应用程序，而不用担心禁用或组织窗口顺序。
每天当我开发 MIRA 时，无论是 Web 版本还是桌面版本，
...
<video autoplay controls muted loop playsinline>
  <source src="./assets/mira-demo-resize.mp4" type="video/mp4">
  您的浏览器不支持视频标签。
</video>
...
<ThemedVideo autoplay src="./assets/mira-demo-resource-island.mp4" />
...
[candle-examples](https://github.com/proj-mira/candle-examples) 中进行的实验，
...
我们知道现在配置 MIRA 相当复杂（但如果与许多其他纯 Python 基础的相比仍然容易，
那些需要你理解代码结构来配置）。

感谢 [Me1td0wn76 (melty kiss)](https://github.com/Me1td0wn76) 的贡献，
为 Web 版本添加了引导界面支持，现在你可以在第一次使用 MIRA 时
获得更好的体验。

他们在 Pull Request 合并后写了一篇博客来分享
贡献 Project Mira 的经验：[MIRAプロジェクトに参加した話 - YAMA-blog](https://yama-pro.blog/posts/mira/)

<img class="light" src="./assets/mira-demo-onboarding-light.avif" alt="引导界面亮色模式" />
<img class="dark" src="./assets/mira-demo-onboarding-dark.avif" alt="引导界面暗色模式" />
...
<img class="light" src="./assets/mira-demo-vrm-light.avif" alt="VRM 亮色模式" />
<img class="dark" src="./assets/mira-demo-vrm-dark.avif" alt="VRM 暗色模式" />
...
> UI 组件：https://mira.local/ui/#/story/src-components-gadgets-levelmeter-story-vue

在希望显示检测到的音频输入电平或实时系统负载时很有用：

<img class="light" src="./assets/mira-ui-level-meter-light.avif" alt="电平表亮色模式" />
<img class="dark" src="./assets/mira-ui-level-meter-dark.avif" alt="电平表暗色模式" />

#### 时间序列图表

> UI 组件：https://mira.local/ui/#/story/src-components-gadgets-timeserieschart-story-vue

类似于用于变化值的电平表，但对于历史数据特别有用。

<img class="light" src="./assets/mira-ui-time-series-chart-light.avif" alt="时间序列图表亮色模式" />
<img class="dark" src="./assets/mira-ui-time-series-chart-dark.avif" alt="时间序列图表暗色模式" />

我们还添加了许多更多组件...

- [x] `<Progress />`（感谢 @Menci [2cb602aa](https://github.com/dumkeacee149-blip/mira/commit/2cb602aa3eac456a479b622a5ecf043831597ffe)）
- [x] `<FieldSelect />` ([d0d782ff](https://github.com/dumkeacee149-blip/mira/commit/d0d782ff94a5a0a12819725303f687bd1a47e87c))
- [x] `<Alert />`（感谢 [@typed-sigterm](https://github.com/typed-sigterm), [#295](https://github.com/dumkeacee149-blip/mira/pull/295)）
- [x] `<ErrorContainer />`（感谢 [@typed-sigterm](https://github.com/typed-sigterm), [#295](https://github.com/dumkeacee149-blip/mira/pull/295)）
- [x] 新的侧边栏导航设计
- [x] 消息提示器
- [x] 有新版本时提示用户更新
...
<video class="light" autoplay controls muted loop playsinline>
  <source src="./assets/mira-docs-light.mp4" type="video/mp4">
  您的浏览器不支持视频标签。
</video>

<video class="dark" autoplay controls muted loop playsinline>
  <source src="./assets/mira-docs-dark.mp4" type="video/mp4">
  您的浏览器不支持视频标签。
</video>
...
<img class="light" src="./assets/mira-docs-blogs-light.avif" alt="博客页面亮色模式" />
<img class="dark" src="./assets/mira-docs-blogs-dark.avif" alt="博客页面暗色模式" />
...
请先导航到 https://github.com/dumkeacee149-blip/mira/tree/main/packages/i18n/src/locales。

<img class="light" src="./assets/mira-packages-i18n-light.avif" alt="i18n 包结构亮色模式" />
<img class="dark" src="./assets/mira-packages-i18n-dark.avif" alt="i18n 包结构暗色模式" />
...
使用 `turborepo`，构建 MIRA 所需的时间**从平均 4 分钟减少到 25 秒**。

### 现在支持 Nix

感谢 [@Weathercold (Weathercold)](https://github.com/Weathercold)，我们现在
有了一个 Nix flake 来构建 MIRA，这是对跨平台兼容性的一个很好的补充。
它甚至在 macOS 上也能工作。
...
夜间构建可以在 https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml 找到
...
- [`@proj-mira/chromatic`](https://github.com/proj-mira/chromatic)（由 [@sumimakito](https://github.com/sumimakito) 制作）
- [`@proj-mira/unocss-preset-chromatic`](https://github.com/proj-mira/chromatic)（由 [@sumimakito](https://github.com/sumimakito) 制作）
...
- [`@proj-mira/drizzle-orm-browser`](https://github.com/proj-mira/drizzle-orm-browser)（由我制作）

在这个版本之间诞生的副项目：

- [HuggingFace Inspector](https://hf-inspector.moeru.ai/) (https://github.com/moeru-ai/hf-inspector)
- [关于 whisper & VAD、candle、burn 和 ort 的更多 candle 示例](https://github.com/proj-mira/candle-examples)
...
我们的路线图上的 [Roadmap v0.7](https://github.com/dumkeacee149-blip/mira/issues/200)。
