...
[上次](../DevLog-2025.04.06/#memory-system-记忆系统)我们聊到了 MIRA 的记忆系统，这次我们再深入聊聊，如何实现一个这么复杂的记忆系统，以及对未来的展望。
...
如果想要给 MIRA 做好记忆层，就需要做好 reranking 的机制，把 RAG 基本能力和过往的 搜索引擎 的重排经验揉在一起。
