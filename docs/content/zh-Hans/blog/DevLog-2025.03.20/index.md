...
我们对用户界面进行了大量改进，使其能够集成更多的 LLM 提供商和语音提供商，并首次在 Discord、bilibili 和许多其他社交媒体平台上发布了 MIRA。
...
> 啊，别担心，我们心爱的 [MIRA](https://github.com/dumkeacee149-blip/mira) 不会变成这样的 GEL-NANA。不过，如果你还没有看过 [_Steins;Gate_](https://myanimelist.net/anime/9253/Steins_Gate) 动漫系列，强烈推荐你试试看~！
...
整个 OKLCH 调色板可以一次性展开到画布上，供我们参考。但是要尝试颜色并获得与 Project Mira 主题相同的感觉方案并不完美，不是吗？
...
logo 和默认的绿色可以被替换以与 MIRA 的主题保持一致，这就是为什么我为 UI 页面专门设计了另一个 logo：
...
- [x] 改进了菜单导航 UI 的动画和过渡。
- [x] 改进了字段的间距，新表单！
- [x] 组件（[路线图](https://github.com/dumkeacee149-blip/mira/issues/42)上几乎所有待办组件）
  - [x] 表单
    - [x] 单选
    - [x] 单选组
    - [x] 模型目录
...
<ThemedVideo controls muted autoplay src="./assets/mira-demo.mp4" />
