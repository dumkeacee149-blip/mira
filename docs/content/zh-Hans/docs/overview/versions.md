---
title: 版本与下载
description: MIRA 的不同版本以及如何获取它们
---
...
MIRA 提供多个发布渠道以满足不同需求。无论你想要最稳定的体验还是最新的功能,我们都能满足你的需求。
...
[在 GitHub 上查看所有版本 →](https://github.com/dumkeacee149-blip/mira/releases)
...
1. 访问 [每夜构建工作流](https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml) 页面
...
4. 下载适合你平台的构建版本:
   ...
   - **Linux (x64)**: \`mira_*_amd64.deb\` 或 \`mira-*.x86_64.rpm\`
   - **Linux (ARM64)**: \`mira_*_arm64.deb\` 或 \`mira-*.aarch64.rpm\`
...
[查看所有每夜构建版本 →](https://github.com/dumkeacee149-blip/mira/actions/workflows/release-tamagotchi.yml)
