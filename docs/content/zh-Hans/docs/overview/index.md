---
title: 这是什么项目？
description: 了解 Project Mira 的用户界面
---
...
客户端则更适合进行高级操作，例如 VTuber 直播、computer-use 以及访问本地 LLM 模型，此时无需为运行 MIRA 支付大量 token 费用。
...
Project Mira 目前正处于活跃的早期开发阶段。您在发布的客户端或网页版中体验到的主要为基础的稳定功能。如果您想体验正在开发中的 **实验性功能**（如 Minecraft 智能体、Discord / Telegram 机器人等），**目前暂时只能通过拉取项目源码在本地配置并启动**。
...
有关如何设计和改进 Project Mira 用户界面的参考资料，请参阅 [设计指南](../contributing/design-guidelines/resources) 页面。
