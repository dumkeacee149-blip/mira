# MIRA Plugin - Web Extension

> Read what you are reading!

This is a plugin for the MIRA to understand what you are reading, looking at, or listening to on the web.
...
1. `pnpm -F @proj-mira/mira-plugin-web-extension dev`
