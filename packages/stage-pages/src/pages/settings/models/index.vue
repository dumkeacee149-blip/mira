...
import type { Live2DCanvas } from '@proj-mira/stage-ui/components/scenes'

import { ModelSettings } from '@proj-mira/stage-ui/components/scenarios/settings/model-settings'
