import type { ContextUpdate, WebSocketBaseEvent, WebSocketEvent, WebSocketEventOptionalSource, WebSocketEvents } from '@proj-mira/server-sdk'

import { Client, WebSocketEventSource } from '@proj-mira/server-sdk'
...
export const useModsServerChannelStore = defineStore('mods:channels:proj-mira:server', () => {
  ...
  const defaultWebSocketUrl = import.meta.env.VITE_MIRA_WS_URL || 'ws://localhost:6121/ws'
