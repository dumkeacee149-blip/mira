import type { BeatSyncDetectorState } from '@proj-mira/stage-shared/beat-sync'

import { getBeatSyncState, listenBeatSyncStateChange } from '@proj-mira/stage-shared/beat-sync'
...
export function useModulesList() {
  ...
  const modulesList = computed<Module[]>(() => [
    ...
    {
      id: 'runtime-health',
      name: t('settings.pages.modules.runtime-health.title'),
      description: t('settings.pages.modules.runtime-health.description'),
      icon: 'i-solar:programming-bold-duotone',
      to: '/settings/modules/runtime-health',
      configured: false,
      category: 'essential',
    },
    {
