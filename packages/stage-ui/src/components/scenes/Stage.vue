...
import type { DuckDBWasmDrizzleDatabase } from '@proj-mira/drizzle-duckdb-wasm'
import type { Live2DLipSync, Live2DLipSyncOptions } from '@proj-mira/model-driver-lipsync'
import type { Profile } from '@proj-mira/model-driver-lipsync/shared/wlipsync'
import type { SpeechProviderWithExtraOptions } from '@xsai-ext/providers/utils'
import type { UnElevenLabsOptions } from 'unspeech'

import type { EmotionPayload } from '../../constants/emotions'

import { drizzle } from '@proj-mira/drizzle-duckdb-wasm'
import { getImportUrlBundles } from '@proj-mira/drizzle-duckdb-wasm/bundles/import-url-browser'
import { createLive2DLipSync } from '@proj-mira/model-driver-lipsync'
import { wlipsyncProfile } from '@proj-mira/model-driver-lipsync/shared/wlipsync'
import { createPlaybackManager, createSpeechPipeline } from '@proj-mira/pipelines-audio'
import { Live2DScene, useLive2d } from '@proj-mira/stage-ui-live2d'
import { ThreeScene } from '@proj-mira/stage-ui-three'
import { animations } from '@proj-mira/stage-ui-three/assets/vrm'
import { createQueue } from '@proj-mira/stream-kit'
...
import { useMiraCardStore } from '../../stores/modules'
...
const { post: postPresent } = useBroadcastChannel<PresentEvent, PresentEvent>({ name: 'mira-chat-present' })
...
const { activeCard } = storeToRefs(useMiraCardStore())
