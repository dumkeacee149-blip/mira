# @proj-mira/plugin-protocol

Shared protocol contracts for plugin-module communication in Project Mira.
...
```ts
import type { WebSocketEvent, WebSocketEventOf, WebSocketEvents } from '@proj-mira/plugin-protocol/types'

import { moduleAnnounce, moduleAuthenticate } from '@proj-mira/plugin-protocol/types'
```
