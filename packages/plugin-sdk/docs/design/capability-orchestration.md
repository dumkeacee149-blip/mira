...
The MIRA ecosystem is moving toward:
...
MIRA plugin orchestration should behave like an extensible runtime kernel:
...
- [MIRA Plugin Platform](./architecture.md)
