...
# or
tauri-plugin-mcp = { git = "https://github.com/dumkeacee149-blip/mira", tag = "0.4.27" }
```

You can install the JavaScript Guest bindings using your preferred JavaScript package manager:

```bash
pnpm add @proj-mira/tauri-plugin-mcp
# or use @antfu/ni
ni @proj-mira/tauri-plugin-mcp
```
...
```ts
import { callTool, connectServer, disconnectServer, listTools } from '@proj-mira/tauri-plugin-mcp'

// Sample: Connect to a container running MIRA Android
await connectServer('docker', 'run -i --rm -e ADB_HOST=host.docker.internal ghcr.io/lemonnekogh/mira-android:v0.1.0')
