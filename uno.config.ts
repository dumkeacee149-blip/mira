...
import { presetChromatic } from '@proj-mira/unocss-preset-chromatic'
  ...
  return defineConfig({
    presets: [
      ...
      presetIcons({
        scale: 1.2,
        collections: {
          ...createExternalPackageIconLoader('@proj-mira/lobe-icons'),
          ...createExternalPackageIconLoader('@proj-mira/iconify-meteocons'),
        },
      }),
      presetScrollbar(),
      presetChromatic({
