...
import type { Character, CreateCharacterPayload } from '@proj-mira/stage-ui/types/character'

import { useCharacterStore } from '@proj-mira/stage-ui/stores/characters'
import { CreateCharacterSchema } from '@proj-mira/stage-ui/types/character'
import { Button, FieldInput } from '@proj-mira/ui'
import {
  DialogContent,
  DialogOverlay,
  DialogPortal,
            ...
            <div class="flex-1 overflow-y-auto p-6">
              ...
              <div v-show="activeTab === 'identity'" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                  <FieldInput v-model="form.characterId" label="Handle ID" placeholder="e.g. mira-core" required />
