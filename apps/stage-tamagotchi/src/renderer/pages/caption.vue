...
import { useElectronEventaContext, useElectronMouseAroundWindowBorder, useElectronMouseInWindow } from '@proj-mira/electron-vueuse'
...
const { data } = useBroadcastChannel<CaptionChannelEvent, CaptionChannelEvent>({ name: 'mira-caption-overlay' })
