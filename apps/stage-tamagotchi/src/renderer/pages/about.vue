...
const links = [
  { label: 'Home', href: 'https://mira-assistant.app', icon: 'i-solar:home-smile-outline' },
  { label: 'Documentation', href: 'https://mira-assistant.app/docs', icon: 'i-solar:document-add-outline' },
  { label: 'GitHub', href: 'https://github.com/mira-assistant', icon: 'i-simple-icons:github' },
]
