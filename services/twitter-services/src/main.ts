 ...
 */
async function cleanup(adapters: { mira?: MiraAdapter, mcp?: MCPAdapter }, browserCtx: Context) {
 ...
 */
function setupShutdownHooks(adapters: { mira?: MiraAdapter, mcp?: MCPAdapter }, browserCtx: Context) {
