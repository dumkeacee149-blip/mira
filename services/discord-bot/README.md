...
Allow Mira to talk to you and many other users in Discord voice channels.

## Getting started

```shell
git clone git@github.com:dumkeacee149-blip/mira.git
pnpm i
```
...
```shell
pnpm run -F @proj-mira/discord-bot start
```
